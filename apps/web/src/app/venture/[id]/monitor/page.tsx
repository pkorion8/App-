  ...
  return (
    <main className="mx-auto max-w-5xl p-6">
      ...
      <VentureModeSection mode="simple" className="mt-4">
        ...
        <p className="mt-2 max-w-3xl text-sm leading-6 text-vs-fg-muted">After you test or launch, come back and add real numbers. This is where the app learns the difference between what we imagined and what happened in real life.</p>
      </VentureModeSection>
      ...
      <VentureModeSection mode="simple" className="mt-6 space-y-4">
        ...
        <Card className="border-vs-primary/30"><p className="text-lg font-semibold text-vs-fg">This is the loop that makes the venture smarter.</p><p className="mt-2 text-sm leading-6 text-vs-fg-muted">Idea → research → simulation → build → real results → better decisions. Your earlier assumptions stay visible instead of being silently rewritten.</p></Card>
      </VentureModeSection>
