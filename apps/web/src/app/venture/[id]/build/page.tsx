  ...
  return (
    <main className="mx-auto max-w-6xl p-6">
      <VentureModeSection mode="simple">
        <p className="text-xs font-semibold uppercase tracking-[.2em] text-vs-primary">Step 4</p>
        <h1 className="mt-2 text-3xl font-semibold text-vs-fg">Plan what to build first</h1>
        <p className="mt-2 max-w-3xl text-sm leading-6 text-vs-fg-muted">Turn the idea into a small, practical first version. You do not need to choose every technology yourself—the detailed technical view stays available in Pro mode.</p>
      </VentureModeSection>
