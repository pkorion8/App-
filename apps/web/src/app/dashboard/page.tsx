  ...
  return (
    <main className="mx-auto max-w-5xl p-6">
      <div className="flex flex-wrap items-center justify-between gap-x-4 gap-y-3">
        ...
        <div className="flex flex-wrap items-center gap-x-4 gap-y-2"><Link href="/explore" className="text-sm text-vs-fg-muted hover:underline">Explore</Link><Link href="/channels" className="text-sm text-vs-fg-muted hover:underline">Updates</Link><Link href="/billing" className="text-sm text-vs-fg-muted hover:underline">Billing</Link><form action={signOut}><Button type="submit" variant="ghost">Sign out</Button></form></div>
      </div>
