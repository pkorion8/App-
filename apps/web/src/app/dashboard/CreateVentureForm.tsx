  ...
  return (
    <form action={formAction} className="space-y-4">
      <div>
        ...
        <Input id="name" name="name" placeholder="e.g. Warranty reminder app" required />
      ...
      <div>
        ...
        <Textarea id="rawIdeaText" name="rawIdeaText" rows={5} placeholder="Example: I want an app where people can save a receipt and get reminded before a return, warranty or rebate deadline expires." required />
